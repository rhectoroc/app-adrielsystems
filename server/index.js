...
// Temporary Route for Production Fix
app.get('/api/admin/clean-ledger', async (req, res) => {
    try {
        ...
        res.send('<h1>¡Éxito!</h1><p>El historial financiero ha sido borrado y la restricción fue eliminada en producción.</p>');
    } catch (err) {
        console.error('Error cleaning ledger:', err);
