...
export const BillingHistory = ({ payments }: BillingHistoryProps) => {
    return (
        <div className="glass-card">
            <h2 className="mb-4 text-lg font-heading font-semibold text-gray-100">Historial de Facturación</h2>
            {payments.length === 0 ? (
                <p className="text-gray-400">No se encontró historial de pagos.</p>
            ) : (
